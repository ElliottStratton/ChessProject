...
public class Board {
    ...
    public Board() {
        ...
        Pawn wPOne = new Pawn(true,6,0,this);
        Pawn wPTwo = new Pawn(true,6,1,this);
        Pawn wPThree = new Pawn(true,6,2,this);
        Pawn wPFour = new Pawn(true,6,3,this);
        Pawn wPFive = new Pawn(true,6,4,this);
        Pawn wPSix = new Pawn(true,6,5,this);
        Pawn wPSeven = new Pawn(true,6,6,this);
        Pawn wPEight = new Pawn(true,6,7,this);

        Rook wROne = new Rook(true,7,0,this);
        Rook wRTwo = new Rook(true,7,7,this);
        Knight wKOne = new Knight(true,7,1,this);
        Knight wKTwo = new Knight(true,7,6,this);
        Bishop wBOne = new Bishop(true,7,2,this);
        Bishop wBTwo = new Bishop(true,7,5,this);
        King wKing = new King(true,7,3,this);
        Queen wQueen = new Queen(true,7,4,this);
    }
